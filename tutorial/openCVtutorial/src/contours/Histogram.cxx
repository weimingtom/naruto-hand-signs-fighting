...
Histogram::Histogram(){
//	float pair[2];
//	histDim = DEFAULT_HIST_DIM;
//	*ranges = (float*) calloc(histDim, sizeof(float));
//	for(int i=0; i<histDim; i++){
//		histSizes[i] = DEFAULT_HIST_SIZE;
////		pair[0] = 0;
////		pair[1] = DEFAULT_RANGE;
////		memccpy(*ranges, pair, 2, sizeof(float));
//	}
...
int Histogram::createHistogram(IplImage* inputImage){
...
void Histogram::displayHistogram(const char* win){
